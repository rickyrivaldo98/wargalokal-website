const Sektor = () => {
  return (
    <>
      <div className="section-desatrending container bg-color-gray mx-auto">
        <div style={{ color: "#008000" }} className="text-heading ml-4">
          <h3 className="text-xl font-semibold tracking-wide text-primary">
            Berdasarkan Sektor Pendidikan
          </h3>
          <p>Dari apa yang anda klik</p>
        </div>
        <div className="flex-none md:flex  justify-center items-center  w-full  rounded-lg  mx-auto">
          <div className="card min-w-sm px-16 transition-shadow shadow-xl  bg-white hover:shadow-xl min-w-max my-5 relative rounded mx-2">
            <div className="absolute right-0 p-3 ">
              <p className="bg-primary text-white p-2 text-sm rounded-full">
                Open Volunteer
              </p>
            </div>
          ...
          <div className="container-card">
            <div className="status-volunteer">
              <p className="text-status-volunteer">Open Volunteer</p>
            </div>
            ...
            <div className="container-content-card">
              <div className="content-card">
                ...
                <div className="content-card-text">
                  <span style={{ color: "#008000" }} className="nama-desa">
                    Desa Menawan
                  </span>
                  <span className="nama-kegiatan">Komputer untuk Sesama</span>
                  <p className="jenis-volunteer">Volunteer On technology</p>
