...
const TabKomentar = () => {
    return (
        <>
            <div className="pt-10 pl-10 text-lg">Komentar (1)</div>
            <div className="my-5 px-10 pb-2">
                <div className=" border-l-4 border-green-500 bg-white">
                    <input className="w-full py-10 pl-10" type="text" placeholder="Tulis Sesuatu Disini..." />
                </div>
            </div>
                    ...
                    <div className="p-10 bg-white rounded-2xl">
                        ...
                        <div className="flex self-center">
                            <div className="flex pr-5">
                                <div className="pr-2">Hati</div>
                                <div>727 Likes</div>
                            </div>
                            <div className="flex">
                                <div className="pr-2">Balas</div>
                                <div>Balas(1)</div>
                            </div>
                        </div>
                        <hr className="my-5 bg-black" />
                        <div className="flex mb-5 ml-32">
                            <div className="rounded-full bg-primary w-20 h-20"></div>
                            <div className="w-5/6 ml-5 self-center">
                                <div>Vin Diesel</div>
                                <div>24 Maret 2021, 17:52 PM</div>
