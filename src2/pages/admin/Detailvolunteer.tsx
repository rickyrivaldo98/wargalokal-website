        ...
        <div className="w-full mb-12 px-4">
          <div className="flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded">
            ...
            <div className="my-10 mx-4 rounded-lg shadow-lg">
              <div className="h-80 bg-red-300 rounded-lg"></div>
              <div className="px-4 py-2 text-center">
                <div className="text-3xl pt-2">Desa Makmur Jaya</div>
                <div className="text-3xl font-black text-green-700 py-3">
                  Pemanfaatan Teknologi di Sekolah Desa Makmur Jaya
                </div>
                <div className="text-lg font-black text-gray-500 py-3">Status Volunteer</div>
              </div>
